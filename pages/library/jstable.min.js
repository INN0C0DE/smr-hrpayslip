...
var JSTableDefaultConfig = {
  ...
  JSTable = (function () {
    function e(t) {
      ...
      "string" == typeof t && (s = document.querySelector(t)),
        null !== s &&
          ((this.config = Object.assign({}, JSTableDefaultConfig, a)),
      ...
      _createClass(e, [
        {
          ...
          value: function () {
            ...
            if (
              ...
              (s.className = e.classes.selector),
                e.perPageSelect.forEach(function (t) {
                  var a = t === e.perPage,
                    r = new Option(t, t, a, a);
                  s.add(r);
                }),
                (a = a.replace("{select}", s.outerHTML)),
                (t = t.replace(/\{select\}/g, a));
            ...
            this.table.element.classList.add(e.classes.table),
              (t = t.replace(
                "{pager}",
                "<div class='" + e.classes.pagination + "'></div>"
              )),
              ...
              this.wrapper
                .querySelector("." + e.classes.container)
                .appendChild(this.table.element),
        ...
        },
        {
          ...
          value: function () {
            ...
            a.classList.remove("hidden"),
              this.table.header.getCells().forEach(function (e, a) {
                var s = t.table.head.rows[0].cells[a];
                for (var r in ((s.innerHTML = e.getContent()),
                e.classes.length > 0 && (s.className = e.classes.join(" ")),
                e.attributes))
                ...
                ? this.getPageData(this.currentPage)
                    .then(function (e) {
                      t.table.element.classList.remove("hidden"),
                        ...
                        e.forEach(function (e) {
                          t.table.body.appendChild(
                            e.getFormated(t.columnRenderers)
                          );
                        }),
                    ...
                    .then(function () {
                      t.getDataCount() <= 0 &&
                        ...
                        t.setMessage(t.config.labels.noRows)),
                        t._emit("update");
                    })
                    .then(function () {
        ...
        },
        {
          ...
          value: function () {
            ...
            (e.innerHTML = ""),
              e.appendChild(this.pager.render(this.currentPage));
          },
        },
        {
          key: "_updateInfo",
          ...
          value: function () {
            ...
            return fetch(a, {
              ...
              .then(function (t) {
                return (
                  e._emit("fetchData", t),
                  (e.filteredDataCount = t.recordsFiltered),
                  t.data
                );
              })
              .then(function (e) {
        ...
        },
        {
          ...
          value: function (e) {
            ...
            this.config.serverSide ||
              this.table.dataRows.forEach(function (e) {
                (e.visible = !1),
                  t.searchQuery.split(" ").reduce(function (a, s) {
                    var r,
                      n = e.getCells();
                    return (
                      (r = (n = n.filter(function (e, a) {
                        if (t.columnsNotSearchable.indexOf(a) < 0) return !0;
                      })).some(function (e, t) {
                        if (e.getContent().toLowerCase().indexOf(s) >= 0)
                          return !0;
                      })),
                      a && r
                    );
          ...
          value: function (e, t) {
            ...
            i.forEach(function (e) {
              ...
              this.config.serverSide ||
                ...
                (this.table.dataRows = n)),
              (this.config.serverSide && a) || this.update(),
          ...
          value: function () {
            ...
            this.wrapper.addEventListener("click", function (t) {
              ...
              if (a.hasAttribute("data-page")) {
                ...
                e._emit("paginate", e.currentPage, s),
                  (e.currentPage = s),
                  e.update();
              }
              if ("TH" === a.nodeName && a.hasAttribute("data-sortable")) {
                ...
                t.preventDefault(),
                  e.sort(
                    a.cellIndex,
                    a.classList.contains("asc") ? "desc" : "asc"
                  );
              }
            }),
              this.config.perPageSelect &&
                this.wrapper.addEventListener("change", function (t) {
                  ...
                  if (
                    "SELECT" === a.nodeName &&
                    a.classList.contains(e.config.classes.selector)
                  ) {
                    t.preventDefault();
                    var s = parseInt(a.value, 10);
                    e._emit("perPageChange", e.config.perPage, s),
                      (e.config.perPage = s),
                      e.update();
                  }
                }),
              this.config.searchable &&
                this.wrapper.addEventListener("keyup", function (t) {
                  "INPUT" === t.target.nodeName &&
                    t.target.classList.contains(e.config.classes.input) &&
                    (t.preventDefault(), e.search(t.target.value));
                });
          },
        },
        {
        ...
        },
        {
          ...
          value: function () {
            var e = this,
              ...
              a = null;
            this.config.columns &&
              this.config.columns.forEach(function (s) {
                isNaN(s.select) || (s.select = [s.select]),
                  s.select.forEach(function (r) {
                    var n = e.table.header.getCell(r);
                    if (
                      (s.hasOwnProperty("render") &&
                        "function" == typeof s.render &&
                        (e.columnRenderers[r] = s.render),
                      s.hasOwnProperty("sortable"))
                    ) {
                      var i = !1;
                      n.hasSortable
                        ? (i = n.isSortable)
                        : ((i = s.sortable), n.setSortable(i)),
                        i &&
                          (n.addClass(e.config.classes.sorter),
                          s.hasOwnProperty("sort") &&
                            1 === s.select.length &&
                            ((t = s.select[0]), (a = s.sort)));
                    }
                    s.hasOwnProperty("searchable") &&
                      (n.setAttribute("data-searchable", s.searchable),
                      !1 === s.searchable && e.columnsNotSearchable.push(r));
                  });
              }),
              this.table.header.getCells().forEach(function (s, r) {
                ...
                s.hasSortable
                  ? (n = s.isSortable)
                  : ((n = e.config.sortable), s.setSortable(n)),
                  n &&
                    (s.addClass(e.config.classes.sorter),
                    s.hasSort && ((t = r), (a = s.sortDirection)));
              }),
              null !== t && e.sort(t, a, !0);
          },
        },
  ...
  JSTableElement = (function () {
    function e(t) {
      _classCallCheck(this, e),
        ...
        (this.rows = Array.from(this.element.rows).map(function (e) {
  ...
  JSTableRow = (function () {
    function e(t, a) {
      _classCallCheck(this, e),
        (this.cells = Array.from(t.cells).map(function (e) {
          return new JSTableCell(e);
        })),
        (this.d = this.cells.length),
        (this.isHeader = "THEAD" === a),
        (this.isFooter = "TFOOT" === a),
        (this.visible = !0);
    }
    return (
      _createClass(
          ...
          },
          {
            ...
            value: function (e) {
              var t = document.createElement("tr"),
                a = this;
              return (
                this.getCells().forEach(function (s, r) {
                  var n = document.createElement("td");
                  for (var i in ((n.innerHTML = s.getContent()),
                  e.hasOwnProperty(r) &&
                    (n.innerHTML = e[r].call(a, s.getElement(), r)),
                  s.classes.length > 0 && (n.className = s.classes.join(" ")),
                  s.attributes))
                    n.setAttribute(i, s.attributes[i]);
                  t.appendChild(n);
                }),
                t
              );
  ...
  JSTableCell = (function () {
    function e(t) {
      _classCallCheck(this, e),
        ...
        (this.isSortable = "true" === t.getAttribute("data-sortable")),
        (this.hasSort = t.hasAttribute("data-sort")),
        (this.sortDirection = t.getAttribute("data-sort")),
        (this.classes = []);
      var a = this;
      (this.attributes = {}),
        _toConsumableArray(t.attributes).forEach(function (e) {
      ...
      _createClass(e, [
        ...
        },
        {
          ...
          value: function () {
            ...
            if (t > 1) {
              var s =
                  1 === this.instance.currentPage
                    ? 1
                    : this.instance.currentPage - 1,
                r =
                  this.instance.currentPage === t
                    ? t
                    : this.instance.currentPage + 1;
              e.firstLast &&
                a.appendChild(this.createItem("pager", 1, e.firstText)),
                e.nextPrev &&
                  a.appendChild(this.createItem("pager", s, e.prevText)),
                this.truncate().forEach(function (e) {
                  a.appendChild(e);
                }),
                e.nextPrev &&
                  a.appendChild(this.createItem("pager", r, e.nextText)),
                e.firstLast &&
                  a.appendChild(this.createItem("pager", t, e.lastText));
            }
            return a;
          },
        },
        ...
        },
        {
          ...
          value: function () {
            ...
            if (this.instance.config.truncatePager) {
              r < 4 - a.pagerDelta + s
                ? (i = 3 + s)
                : r > this.getPages() - (3 - a.pagerDelta + s) &&
                  (n = this.getPages() - (2 + s));
              for (var u = 1; u <= o; u++)
                (1 === u || u === o || (u >= n && u <= i)) && l.push(u);
              l.forEach(function (s) {
                e &&
                  (s - e == 2
                    ? c.push(t.createItem("", e + 1, e + 1))
                    : s - e != 1 &&
                      c.push(
                        t.createItem(a.classes.ellipsis, 0, a.ellipsisText, !0)
                      )),
                  c.push(t.createItem(s == r ? "active" : "", s, s)),
                  (e = s);
              });
            } else
              for (var h = 1; h <= this.getPages(); h++)
                c.push(this.createItem(h === r ? "active" : "", h, h));
            return c;
          },
        },
      ]),
