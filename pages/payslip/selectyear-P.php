...
<!-- ========================= MODAL ======================= -->
<div id="sprintyear" class="modal fade">
<form method="post" action="printyear-P.php"> <!-- Updated the action attribute -->
        <div class="modal-dialog modal-sm" style="width:800px !important;">
            <div class="modal-content">
                ...
                <button type="button" class="btn btn-primary btn-sm" name="btn_payslip" id="btn_payslip" onclick="submitFormprintyear()">Print</button>
            <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Cancel</button>
        </div>
    </form>
<script>
    // JavaScript function to handle form submission and redirect to print4.php
    function submitFormprintyear() {
        // Get the form element
        const form = document.querySelector("#sprintyear form");

        // Set the form action to print4.php
        form.action = "printyear-P.php";
