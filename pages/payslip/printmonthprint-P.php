          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div id="printContent" style="  display: grid !important;
                ...
                if (isset($_POST['txt_employee']) && isset($_POST['txt_month'])) {
                  ...
                  // Modify the query to include the WHERE clause with employee and month filter
                ...
                INNER JOIN tbl_range r ON p.daterange = r.oid
                                      WHERE p.employee = '$employeeId' AND p.month_ = '$month' ");
              ...
              <div style="position: relative; border: 3px solid rgba(0, 0, 0, 1); border-radius: 0.25rem; width: 4in; height: 6.3 in;  z-index:1">
                ...
                <div style="margin:0.5rem; flex: 1 1 auto;">
                  <p style="font-size: 12px; border-spacing: 20px; margin: 5 0 5 0;">Name: <span style="border-bottom: 1px solid black; height: 12px;; width: 75px; text-align: center; font-weight:bolder;">
                  <?php
...
?>
                  ...
                  <div style="display: flex; flex-wrap: wrap;">
                    <div style="flex: 0 0 70%; max-width: 70%;">
                      ...
                      <p style="font-size: 12px; border-spacing: 20px; margin: 5 0 5 0;" class="fw-bold details"><strong>PHILHEALTH:</strong><span style="float: right; <?php echo ($row['phihealthtype'] === 'add') ? 'color: black !important;' : 'color: rgb(255, 0, 0) !important;'; ?> padding: 0; border-bottom: 1px solid black; height: 17px; width: 75px; text-align: center;"><?php echo !empty($row['phihealth']) ? number_format($row['phihealth'], 2, '.', ',') : ''; ?> </span></p>

                      <p style="font-size: 12px; border-spacing: 20px; margin: 5 0 5 0;" class="fw-bold details">
                        <strong>Withholding Tax:</strong>
                        <span style="float: right; <?php echo ($row['wholdtaxtype'] === 'add') ? 'color: black !important;' : 'color: red !important;'; ?> padding: 0; border-bottom: 1px solid black; height: 17px; width: 75px; text-align: center;">
                    ...
                    <div style="flex: 0 0 30%; max-width: 30%;">
                      <p style="transform: rotate(-90deg); width: 200px; height: 100px; top: 80px; right: -55px; font-weight: 600; position: relative;">CRISTINA F. CABUSAY</p>
                      <p style="transform: rotate(-90deg); width: 250px; height: 100px; top: -100px; right: -50px; position: relative;">Head-HRMO</p>
                    </div>
                  </div>
                  <!-- END ROW -->
    ...
    letter-spacing: 2px;"> <?php echo number_format($netsalary, 2, '.', ','); ?></span></p>
                ...
                <p style="font-size: 12px; text-align: center; font-weight: 600;  color: red !important; display:none;">FOR FILING PURPOSES ONLY</p>
              </div>
            </div>
