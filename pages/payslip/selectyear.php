...
<!-- ========================= MODAL ======================= -->
<div id="selectprintyear" class="modal fade">
<form method="post" action="printyear.php"> <!-- Updated the action attribute -->
        <div class="modal-dialog modal-sm" style="width:800px !important;">
            <div class="modal-content">
                ...
                <button type="button" class="btn btn-primary btn-sm" name="btn_payslip" id="btn_payslip" onclick="submitFormmonthyear()">Print</button>
...
<script>
    ...
    function submitFormmonthyear() {
        // Get the form element
        const form = document.querySelector("#selectprintyear form");

        // Set the form action to print4.php
        form.action = "printyear.php";
