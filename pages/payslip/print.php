<div id="print<?php echo $row['oid']; ?>" class="modal fade" role="dialog" data-type="certificate">
  <div class="modal-dialog">
    <div class="modal-content" style="width: auto; ">
      ...
      <div class="modal-body">
        <div id="print-content-certificate-<?php echo $row['oid']; ?>">
          ...
          <body style="font-family:Arial, Helvetica, sans-serif">
            <div>
              <div style="position: relative; border: 3px solid rgba(0, 0, 0, 1); border-radius: 0.25rem; width: 4in; height: 6.1in;  z-index:1">
                ...
                <div style="margin:0.5rem; flex: 1 1 auto;">
                  <p style="font-size: 12px; border-spacing: 20px; margin: 0;">Name: <span style="border-bottom: 1px solid black; height: 12px;; width: 75px; text-align: center; font-weight:bolder;"><?php echo $row['lname'] . ', ' . $row['fname'] . ' ' . $row['suffix'] . ' ' . $row['mname'] . ''; ?></span></p>
                  <p style="font-size: 12px; border-spacing: 20px; margin: 0; ">Period Covered: <span style="border-bottom: 1px solid black; height: 12px;; width: 75px; text-align: center;"> <?php
                                                                                                                                                                                                ...
                                                                                                                                                                                                echo $formatted_date;
                                                                                                                                                                                                ?> </span> </p>
                  <p style="font-size: 12px; border-spacing: 20px; margin: 0;">Purpose: <span style="border-bottom: 1px solid black; height: 12px;; width: 75px; text-align: center;"> <?php echo $row['purpose']; ?> </span></p>
                  ...
                  <p style="font-size: 12px; border-spacing: 20px; margin: 0;">RATA: <span style="float: right"> <?php echo !empty($row['rata']) ? number_format($row['rata'], 2, '.', ',') : ''; ?> </span></p>
                  <p style="font-size: 12px; border-spacing: 20px; margin: 0;">Others: <strong><?php echo $row['othersadd']; ?></strong> <span style="float: right"> <?php echo !empty($row['othersaddvalue']) ? number_format($row['othersaddvalue'], 2, '.', ',') : ''; ?></span></p>
                  <p style="font-size: 12px; border-spacing: 20px; margin: 0; border-top: 1px solid black; float: right; font-weight: bold;"> Total: <?php echo number_format($total, 2, '.', ','); ?></p>
                  <br />
                  <!-- DEDUCTIONS -->
                  <div style="display: flex; flex-wrap: wrap;">
                    <div style="flex: 0 0 70%; max-width: 70%;">
                      ...
                      <ul style="list-style-type: circle; margin-left: 20px; padding-left: 10px; font-size: 12px; margin:0;">
    ...
    letter-spacing: 2px;"> <?php echo number_format($netsalary, 2, '.', ','); ?></span></p>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" onclick="printCertificate(<?php echo $row['oid']; ?>)">Print</button>
...
<div id="filing<?php echo $row['oid']; ?>" class="modal fade" role="dialog" data-type="filing">
  <div class="modal-dialog">
    <div class="modal-content" style="width: 800px !important;">
      <div class="modal-header">
        <h4 class="modal-title">Print filing Document</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <div id="print-content-filing-<?php echo $row['oid']; ?>">
          <!-- Filing contents here -->
          <?php
          // Assuming you have fetched data from the database and stored it in $row variable
                ...
                <div style="margin:0.5rem; flex: 1 1 auto;">
                  ...
                  <div style="display: flex; flex-wrap: wrap;">
                    ...
                    <div style="flex: 0 0 30%; max-width: 30%;">
                      ...
                      <p style="transform: rotate(-90deg); width: 250px; height: 100px; height: 100px; top: -100px; position: relative; display:none;">Head-HRMO</p>
                    </div>
                  </div>
                  <!-- END ROW -->
                  ...
                  <p style="font-size: 12px; border-spacing: 20px; margin: 0; margin-top: 10px;" class="fw-bold details"><strong>NET SALARY:</strong> <span style="float: right;border-bottom: 1px solid black; height: 17px;; width: 100px; text-align: right; font-weight: bolder; font-size: 14px;
    letter-spacing: 2px;"> <?php echo number_format($netsalary, 2, '.', ','); ?></span></p>
                </div>
                <p style="font-size: 12px; text-align: center; font-weight: 600;  color: red !important; margin-top: -5px; ">FOR FILING PURPOSES ONLY</p>
              </div>
            </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" onclick="printFiling(<?php echo $row['oid']; ?>)">Print</button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
