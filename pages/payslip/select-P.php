...
<!-- ========================= MODAL ======================= -->
<div id="sprint" class="modal fade">
    <form method="post" action="printmonthprint-P.php"> <!-- Updated the action attribute -->
        <div class="modal-dialog modal-sm" style="width:800px !important;">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm" name="btn_payslip" id="btn_payslip" onclick="submitFormprint()">Print</button>
    ...
    function submitFormprint() {
        ...
        form.action = "printmonthprint-P.php";
