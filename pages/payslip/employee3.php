                            ...
                            <form method="post">
                                <table id="table" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        child4, child5 FROM tbl_employee");
                                        while ($row = mysqli_fetch_array($squery)) {
                                            echo '
                                                <tr>
                                                    ...
                                                    <td>                                                    
                                                    <button class="btn btn-primary btn-sm" data-target="#editpicture' . $row['oid'] . '" data-toggle="modal"><i class="fa fa-plus-square" aria-hidden="true"></i> Update Picture</button>     
                                                    </td>
                                                </tr>
                                                ';
